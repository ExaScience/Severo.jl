...
@testset "t-test" begin
    true_scores = [
        ...
        -0.9331775    0.9331775
        -2.8450732    2.845073
         0.57457656  -0.57457656
        -1.5263917    1.5263917
        -2.0760367    2.0760367
        -2.3522618    2.3522618
         0.11647039  -0.11647039
        -0.236924     0.236924
         0.88779753  -0.88779753
         0.0          0.0
        -2.7801418    2.7801418
         0.03009087  -0.03009087
         0.26995564  -0.26995564
        -0.02044845   0.02044845
         0.7680498   -0.7680497
        -2.3138392    2.3138392
         0.0773671   -0.0773671
         0.34870306  -0.34870306
         0.25511038  -0.25511038
   ]

    scores, pvals, logfc = Cell.findmarkers(X, lbls, method=:t)
    @test scores ≈ true_scores atol=1e-6
end
...
@testset "wilcoxon" begin
    ...
    scores, pvals, logfc = Cell.findmarkers(X, lbls, method=:wilcoxon)
    @test pvals ≈ true_pvals atol=1e-6
end
